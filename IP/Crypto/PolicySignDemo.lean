...
def policySignDemo {dom : DomainConfig}
  ...
  circuit do
    ...
    let ml0 := ((BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 448 8 v) : Signal dom (BitVec 8)) <*> (BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 456 8 v) : Signal dom (BitVec 8)) <*> (BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 464 8 v) : Signal dom (BitVec 8)) <*> (BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 472 8 v) : Signal dom (BitVec 8)) <*> (BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 480 8 v) : Signal dom (BitVec 8)) <*> (BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 488 8 v) : Signal dom (BitVec 8)) <*> (BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 496 8 v) : Signal dom (BitVec 8)) <*> (msg512.map (fun v => BitVec.extractLsb' 504 8 v) : Signal dom (BitVec 8))))))))) : Signal dom (BitVec 64))
    let ml1 := ((BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 384 8 v) : Signal dom (BitVec 8)) <*> (BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 392 8 v) : Signal dom (BitVec 8)) <*> (BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 400 8 v) : Signal dom (BitVec 8)) <*> (BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 408 8 v) : Signal dom (BitVec 8)) <*> (BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 416 8 v) : Signal dom (BitVec 8)) <*> (BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 424 8 v) : Signal dom (BitVec 8)) <*> (BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 432 8 v) : Signal dom (BitVec 8)) <*> (msg512.map (fun v => BitVec.extractLsb' 440 8 v) : Signal dom (BitVec 8))))))))) : Signal dom (BitVec 64))
    let ml2 := ((BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 320 8 v) : Signal dom (BitVec 8)) <*> (BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 328 8 v) : Signal dom (BitVec 8)) <*> (BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 336 8 v) : Signal dom (BitVec 8)) <*> (BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 344 8 v) : Signal dom (BitVec 8)) <*> (BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 352 8 v) : Signal dom (BitVec 8)) <*> (BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 360 8 v) : Signal dom (BitVec 8)) <*> (BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 368 8 v) : Signal dom (BitVec 8)) <*> (msg512.map (fun v => BitVec.extractLsb' 376 8 v) : Signal dom (BitVec 8))))))))) : Signal dom (BitVec 64))
    let ml3 := ((BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 256 8 v) : Signal dom (BitVec 8)) <*> (BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 264 8 v) : Signal dom (BitVec 8)) <*> (BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 272 8 v) : Signal dom (BitVec 8)) <*> (BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 280 8 v) : Signal dom (BitVec 8)) <*> (BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 288 8 v) : Signal dom (BitVec 8)) <*> (BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 296 8 v) : Signal dom (BitVec 8)) <*> (BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 304 8 v) : Signal dom (BitVec 8)) <*> (msg512.map (fun v => BitVec.extractLsb' 312 8 v) : Signal dom (BitVec 8))))))))) : Signal dom (BitVec 64))
    let ml4 := ((BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 192 8 v) : Signal dom (BitVec 8)) <*> (BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 200 8 v) : Signal dom (BitVec 8)) <*> (BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 208 8 v) : Signal dom (BitVec 8)) <*> (BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 216 8 v) : Signal dom (BitVec 8)) <*> (BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 224 8 v) : Signal dom (BitVec 8)) <*> (BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 232 8 v) : Signal dom (BitVec 8)) <*> (BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 240 8 v) : Signal dom (BitVec 8)) <*> (msg512.map (fun v => BitVec.extractLsb' 248 8 v) : Signal dom (BitVec 8))))))))) : Signal dom (BitVec 64))
    let ml5 := ((BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 128 8 v) : Signal dom (BitVec 8)) <*> (BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 136 8 v) : Signal dom (BitVec 8)) <*> (BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 144 8 v) : Signal dom (BitVec 8)) <*> (BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 152 8 v) : Signal dom (BitVec 8)) <*> (BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 160 8 v) : Signal dom (BitVec 8)) <*> (BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 168 8 v) : Signal dom (BitVec 8)) <*> (BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 176 8 v) : Signal dom (BitVec 8)) <*> (msg512.map (fun v => BitVec.extractLsb' 184 8 v) : Signal dom (BitVec 8))))))))) : Signal dom (BitVec 64))
    let ml6 := ((BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 64 8 v) : Signal dom (BitVec 8)) <*> (BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 72 8 v) : Signal dom (BitVec 8)) <*> (BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 80 8 v) : Signal dom (BitVec 8)) <*> (BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 88 8 v) : Signal dom (BitVec 8)) <*> (BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 96 8 v) : Signal dom (BitVec 8)) <*> (BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 104 8 v) : Signal dom (BitVec 8)) <*> (BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 112 8 v) : Signal dom (BitVec 8)) <*> (msg512.map (fun v => BitVec.extractLsb' 120 8 v) : Signal dom (BitVec 8))))))))) : Signal dom (BitVec 64))
    let ml7 := ((BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 0 8 v) : Signal dom (BitVec 8)) <*> (BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 8 8 v) : Signal dom (BitVec 8)) <*> (BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 16 8 v) : Signal dom (BitVec 8)) <*> (BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 24 8 v) : Signal dom (BitVec 8)) <*> (BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 32 8 v) : Signal dom (BitVec 8)) <*> (BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 40 8 v) : Signal dom (BitVec 8)) <*> (BitVec.append <$> (msg512.map (fun v => BitVec.extractLsb' 48 8 v) : Signal dom (BitVec 8)) <*> (msg512.map (fun v => BitVec.extractLsb' 56 8 v) : Signal dom (BitVec 8))))))))) : Signal dom (BitVec 64))
