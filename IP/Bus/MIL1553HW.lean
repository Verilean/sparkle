...
def oddParityHW {dom : DomainConfig}
  ...
  let bit1  := ((content >>> (Signal.pure  1#16 : Signal dom (BitVec 16))) &&& m1
      : Signal dom (BitVec 16))
  let bit2  := ((content >>> (Signal.pure  2#16 : Signal dom (BitVec 16))) &&& m1
      : Signal dom (BitVec 16))
  let bit3  := ((content >>> (Signal.pure  3#16 : Signal dom (BitVec 16))) &&& m1
      : Signal dom (BitVec 16))
  let bit4  := ((content >>> (Signal.pure  4#16 : Signal dom (BitVec 16))) &&& m1
      : Signal dom (BitVec 16))
  let bit5  := ((content >>> (Signal.pure  5#16 : Signal dom (BitVec 16))) &&& m1
      : Signal dom (BitVec 16))
  let bit6  := ((content >>> (Signal.pure  6#16 : Signal dom (BitVec 16))) &&& m1
      : Signal dom (BitVec 16))
  let bit7  := ((content >>> (Signal.pure  7#16 : Signal dom (BitVec 16))) &&& m1
      : Signal dom (BitVec 16))
  let bit8  := ((content >>> (Signal.pure  8#16 : Signal dom (BitVec 16))) &&& m1
      : Signal dom (BitVec 16))
  let bit9  := ((content >>> (Signal.pure  9#16 : Signal dom (BitVec 16))) &&& m1
      : Signal dom (BitVec 16))
  let bit10 := ((content >>> (Signal.pure 10#16 : Signal dom (BitVec 16))) &&& m1
      : Signal dom (BitVec 16))
  let bit11 := ((content >>> (Signal.pure 11#16 : Signal dom (BitVec 16))) &&& m1
      : Signal dom (BitVec 16))
  let bit12 := ((content >>> (Signal.pure 12#16 : Signal dom (BitVec 16))) &&& m1
      : Signal dom (BitVec 16))
  let bit13 := ((content >>> (Signal.pure 13#16 : Signal dom (BitVec 16))) &&& m1
      : Signal dom (BitVec 16))
  let bit14 := ((content >>> (Signal.pure 14#16 : Signal dom (BitVec 16))) &&& m1
      : Signal dom (BitVec 16))
  let bit15 := ((content >>> (Signal.pure 15#16 : Signal dom (BitVec 16))) &&& m1
      : Signal dom (BitVec 16))
