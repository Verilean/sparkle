...
| **[SV→Sparkle Transpiler](docs/RV32.md#sv-transpiler)** | Parse Verilog → JIT + formal verification. `verilog!` macro, `assert` auto-proof via `bv_decide`. C firmware: Fib, Sort, GCD | 6+ theorems | JIT | 11 parser tests |
