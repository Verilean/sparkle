...
| 4 | **SV Transpiler: Extended ISA** | M-ext: 8-bit MUL standalone PASS. Full SoC compiles, CPU executes but stalls at PC=0x64 (~25 instructions). PCPI FSM transition issue with WITH_PCPI=1 | In progress |
