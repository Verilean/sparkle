...
| 4 | **SV Transpiler: Extended ISA** | M-ext carry-save MUL works (8-bit standalone PASS). Full PicoRV32 blocked by cpuregs[] memory-vs-scalar type in CppSim. Sequential always @* emit, SSA, forLoop unroll, [+:] all working | In progress |
