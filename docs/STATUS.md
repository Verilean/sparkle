...
| 4 | **SV Transpiler: Extended ISA** | M-extension (MUL/DIV): parser accepts ENABLE_MUL=1/ENABLE_DIV=1 (152 regs), but PCPI sub-module flattening breaks execution. CSR/IRQ not yet tested | Investigated |
