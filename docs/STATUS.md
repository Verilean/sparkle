...
| 4 | **SV Transpiler: Extended ISA** | M-ext: carry-save accumulator parsed+unrolled. Blocking assignment self-reference in forLoop needs SSA-style wire naming. CSR/IRQ not yet tested | In progress |
